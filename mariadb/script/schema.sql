...
INSERT INTO app_user (id, username, password, email, display_name, is_active, last_modified_date, last_modified_by) VALUES (2, 'john3', /*456*/'$2a$10$cNwLajdYxWN6ao1ynC0PBugoJqTr2krISx1FFEQ2n8eXX5S.5OW2y', 'test2@localhost.com', 'boss', 'Y', CURDATE(), 'sysadmin');
INSERT INTO app_user (id, username, password, email, display_name, is_active, last_modified_date, last_modified_by) VALUES (2, 'john4', /*456*/'$2a$10$cNwLajdYxWN6ao1ynC0PBugoJqTr2krISx1FFEQ2n8eXX5S.5OW2y', 'test2@localhost.com', 'boss', 'Y', CURDATE(), 'sysadmin');
